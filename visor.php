      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
           <li><a href="index.php"><img border=0 src="vendor/img/home.png"></a></li>
           <li style="color:#FFFFFF"><a style="color:#FFFFFF" href="geotrack.php" style="color:#FFFF">GeoTracker</a></li>
           <li style="color:#FFFFFF"><a style="color:#FFFFFF" target="blank" href="https://docs.google.com/spreadsheets/d/1Ny5WKypBGe_hTLAjxBG4CKPwPwQQ31GCt43-2O0nRhI/edit?usp=sharing">Reportes</a></li>
                      <li style="color:#FFFFFF"><a style="color:#FFFFFF" target="blank" href="https://docs.google.com/spreadsheets/d/1bUUly3GRlazp0jD3cytdnfsvAt7wYWScSJyOGU7zl7Y/edit?usp=sharing">Evaluaciones</a></li>
...
<!--             <li style="color:#FFFFFF"><a style="color:#FFFFFF" href="security/logout.php" style="color:#FFFF">Salir</a></li> -->
      ...
      <div class="starter-template">
                                ...
                                <div class="row">
                                                ...
                                                <div class="input-group">
                                                        <div class="input-group-btn">
                                                                <select id="select-negocio" class="form-control priority-value">
                                                                        <option value="todo">Todas</option>
                                                                        <option value="COMERCIAL ALLAN S.A.S">COMERCIAL ALLAN S.A.S</option>
                                                                        <option value="Expertos En Café">Expertos En Café</option>
                                                                        <option value="Franquicias Unidas Del Perú">Franquicias Unidas Del Perú</option>
                                                                </select>
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                                Periodo
                                                <div>   
                                                        <input type="checkbox" name="chk_group[]"  value="2014-7" class="periods" />2014-07 (Julio)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2014-8" class="periods" />2014-08 (Agosto)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2014-9" class="periods" />2014-09 (Septiembre)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2014-10" class="periods" />2014-10 (Octubre)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2014-11" class="periods" />2014-11 (Noviembre)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2014-12" class="periods" />2014-12 (Diciembre)<br />
                                                        <input type="checkbox" name="chk_group[]"  value="2015-1" class="periods" />2015-1 (Enero)<br />
        ...
        <!-- Total Encuestas-->
         ...
         <div class="container dashboard-content">
                        ...
                        <!-- Grafica 2-->
                        <div class="row">
                                <h3>Cantidad de registros encontrados</h3>
                                <div class="col-md-offset-2">
                                        <div id="chart_div_cantidad"></div>
                                </div>
                        </div>
                        <hr />
                        <!-- Grafica 1-->
                        <div class="row">
                                ...
                                <div class="col-md-12" style="padding-top:4em">
                                  <div id="chart_div_20"></div>
                                        <div >
                                                <span id="ultimo_mes" style="padding-left: 5em;">
                                                
                                                </span>
                                                <span id="acumulado_reloj_1" style="padding-left: 10em;">
                        ...
                        <div class="row">
                                ...
                                <h4></h4>
                                <div class="col-md-12">
                                        <div id="cantidad_indice_fase"></div>
                                        <div id="chart_div_30"></div>
                                </div>
                                <div class="col-md-12">
                                        <div id="cantidad_indice_fase"></div>
                                        <div id="chart_div_referencia"></div>
                                </div>
                        </div>
                        <hr />
                       ...
                       <div class="row">
                          <div class="col-md-15" >
                            <div id="chart_div_historial_venta"></div>   
                          </div>
                       </div>
                      ...
                      <!--Operación-->
                        ...
                        <div class="row">
                          <div class="col-md-15" >
                            <div id="chart_div_historial_operacion"></div>   
                          </div>
                       </div>
                        <div class="row">
                      ...
                      <!--IMAGEN PERSONAL-->
                        ...
                        <div class="row">
                          <div class="col-md-15" >
                            <div id="chart_div_historial_imagen"></div>   
                          </div>
                       </div>
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-15" >
                            <div id="chart_div_historial_ambiente"></div>   
                          </div>
                       </div>
                        <div class="row">
    ...
    <script type="text/javascript" src="scripts/js_charts/chart_personas.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_produtos.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_h_venta.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_h_operacion.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_h_imagen.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_h_ambiente.js"></script>
    <script type="text/javascript" src="scripts/js_charts/chart_referencia.js"></script>
